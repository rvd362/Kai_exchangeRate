...
public class Rate_ListAdapter1 extends RecyclerView.Adapter<Rate_ListAdapter1.ViewHolder>{
    private ArrayList<HashMap<String, Object>> RateData = new ArrayList<HashMap<String, Object>>();
//    int Page = 0;


    public Rate_ListAdapter1(ArrayList<HashMap<String, Object>> dataList) {
        this.RateData.addAll(dataList);
    }


    public class ViewHolder extends RecyclerView.ViewHolder {
        public TextView mBank, mCashBuy, mCashSell;
...
//            mBkSell = (TextView) v.findViewById(R.id.txtBkSell);
            mCashBuy = (TextView) v.findViewById(R.id.txtCashBuy);
            mCashSell = (TextView) v.findViewById(R.id.txtCashSell);
        }
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        final View view = inflater.inflate(R.layout.item_network_rate1, parent, false);
...
//            holder.mBkSell.setText(rateData.get("bksell").toString());
            holder.mCashBuy.setText(rateData.get("cashbuy").toString());
            holder.mCashSell.setText(rateData.get("cashsell").toString());
